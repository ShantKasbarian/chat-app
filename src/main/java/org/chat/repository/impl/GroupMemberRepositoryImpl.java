...
public class GroupMemberRepositoryImpl implements GroupMemberRepository {
    ...
    public Optional<GroupMember> findByGroupIdUserId(UUID groupId, UUID userId) {
        ...
        var groupMember = find(FIND_BY_USER_ID_AND_GROUP_ID, userId, groupId)
                .firstResultOptional();
    ...
    @Override
    public PanacheQuery<GroupMember> findByRole(UUID groupId, GroupMember.Role role, int page, int size) {
        log.debug("fetching for users with groupId {}, role {}", groupId, role);

        var groupMembers = find(FIND_BY_GROUP_ID_AND_ROLE, groupId, role)
    ...
    public PanacheQuery<GroupMember> findByUserId(UUID userId, int page, int size) {
        ...
        var groupMembers = find(USER_ID, userId)
                .page(Page.of(page, size));
