...
public class GroupMemberController {
  ...
  @Operation(
      summary = "create request to join group",
      description = "returns a new group member with PENDING role")
  @APIResponse(
      responseCode = "201",
  ...
  @Path("/members/{id}")
  @Operation(
      summary = "accept join group request",
      description = "updates group member role to MEMBER")
  @APIResponse(
      responseCode = "200",
  ...
  @Path("/{groupId}/members")
  @Operation(
      summary = "get group members by role",
      description = "returns a list of group members with the given role")
  @APIResponse(
      responseCode = "200",
  ...
  public Response getUsersByRole(
      ...
      @QueryParam("role") @DefaultValue("MEMBER") GroupMember.Role role,
