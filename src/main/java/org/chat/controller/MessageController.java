...
public class MessageController {
  ...
  public Response sendMessage(@Valid MessageDto messageDto) {
    ...
    var message =
        messageConverter.convertToModel(
  ...
  public Response getMessages(
    ...
    log.info(
        "GET /messages/{} returning a {} of {} with page {} and size {}",
        userId,
        PageDto.class.getName(),
        MessageDto.class.getName(),
        page,
        size);
    ...
    var message =
        groupMessageConverter.convertToModel(
            messageService.messageGroup(
                userContext.get(), messageDto.text(), messageDto.groupId()));
  ...
  public Response getGroupMessages(
    ...
    log.info(
        "GET /messages/groups/{} returning a {} of {} with page {}, size {}",
        groupId,
        PageDto.class.getName(),
        GroupMessageDto.class.getName(),
        page,
        size);
